    ...
    return (
        ...
        >
            ...
            <div className="flex justify-center items-center">
                <div className="relative z-10 px-4 py-10 sm:px-6 md:px-10 lg:px-20 xl:px-32 2xl:px-40  lg:mt-12">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 sm:gap-14 md:gap-16 lg:gap-32 xl:gap-28 items-center">
